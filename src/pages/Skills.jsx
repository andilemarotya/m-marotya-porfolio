...
const Skills = () => {
  ...
  return (
    <div className='bg-black min-h-40 flex flex-col justify-center items-center text-white text-[Inter]'>
      ...
      {/*Body*/}
      <div className='mt-6 w-[75%] ml-4 mb-4'>
        <h1 className='text-gold mb-4'>Set 1:</h1>
        {/* Grid of images here max of 7 items in a row */}
        {renderImageGrid()}

        <h1 className='text-gold my-4'>Set 2:</h1>
        <p>
          Data Analysis, Team Player, Work under pressure, problem solving, Good communication skills ,Work
          extra hours, Independent part time Guitarist. Team leader, Business Owner, CEO at a startup
          Marotya Studios.
        </p>
